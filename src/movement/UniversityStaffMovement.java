 ...
 * @author Frans Ekman
 */
public class UniversityStaffMovement extends ExtendedMovementModel {
	 ...
	 * @param settings
	 */
	public UniversityStaffMovement(Settings settings) {
		super(settings);
	 ...
	 * @param proto
	 */
	public UniversityStaffMovement(UniversityStaffMovement proto) {
		super(proto);
	...
	public MovementModel replicate() {
		return new UniversityStaffMovement(this);
	}
